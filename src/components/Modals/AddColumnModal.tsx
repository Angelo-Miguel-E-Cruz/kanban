...
export default function AddColumn(
  { isOpen, inputValue, selectedColor, dispatch, onPress }: AddColumnProps) {
  return (
    <Modal isOpen={isOpen} onClose={() => dispatch({ type: 'TOGGLE_MODAL', payload: { modal: 'addColumn', isOpen: false } })}>
